...
hoodies.forEach(hoody => {
		container.innerHTML += `
		   <div class ="product">
		      <img src = "${hoody[4]}" alt="${hoody[0]}">
		      <p class= "name">${hoody[0]}</p>
		      <p class= "color">
			  Color: ${hoody[1]} 
			  </p>
			  <p class = "description">
			  Description: ${hoody[2]} <br>
			  </p>
...
jumpers.forEach(jumper => {
		container.innerHTML += `
		   <div class ="product">
		      <img src = "${jumper[4]}" alt="${jumper[0]}">
		      <p class= "name">${jumper[0]}</p>
		      <p class= "color">
			  Color: ${jumper[1]} 
			  </p>
			  <p class="description">
			  Description: ${jumper[2]} <br>
			  </p>
